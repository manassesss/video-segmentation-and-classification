...
while (True):
    ...
    #mask11 = subtractor1.apply(frame2)   -- it is not being used because the other method preseted the best result if you compare with the other    
    ...
    # Fill the contours and the convex hull
